...
public class Program {
	...
	public static void main(String[] args) throws Throwable {
		// Weaver.weaveAspectForMethodBefore("encryption.chat.Program",
		// "getSrReceiver",
		// "encryption.aspect.ChangeClientCommunicationAspect", "traceBefore",
		...
		for (int i = 1; i < minIter || (i <= maxIterations && !areWeDone(executionTimes, k, CoV)); i++) {
			...
			// "getSrReceiver",
			// "encryption.aspect.ChangeServerCommunicationAspect",
			// "getSrReceiverAround",
			// DataInputStream.class)
			// : Weaver.weaveAspectForMethodAround("encryption.chat.Program",
			// "getSwSender",
			// "encryption.aspect.ChangeClientCommunicationAspect",
			// "getSwSenderAround",
