...
public class MainWindow extends JFrame {
	...
	public static boolean drawConsole = false, drawCanvas = false;
	 ...
	 * 
	 *  public void run() {// //
	 * PropertyConfigurator.configure("../log4j.properties"); final pruebaBis p
	 * = new pruebaBis(); long ini = System.currentTimeMillis();
	 * 
	...
	public static boolean log = false, profile = false;
	...
	public void activateProfiler() {
		// String loadConnector = null;
		// loadConnector =
		// "D:/USR/antiguo/JMFR/tesis/pruebas_otros_sistemas/AspectosWithJasco/src/aspect/ConnectorProfiler.con";
		// logical.loadConnector(loadConnector);
		profile = true;
	}
	...
	public void actLog() {
		if (log)
			AspectLogger.activationMessage(this);
	}

	public void actProfiler() {
		if (profile)
			AspectProfiler.activateProfiler(this);
	}
	...
	public void disactivateLog() {
		...
		if (log) {
			AspectLogger.deactivationMessage(this);
			log = false;
		}
	}
	...
	public void disactivateProfiler() {
		...
		// logical.removeConnector(con);
		if (profile) {
			AspectProfiler.deactivateProfiler(this);
			profile = false;
		}
	}
