...
import org.jboss.aspects.mock.MockAspect;
...
public class MainWindow extends JFrame {
	...
	private static AdviceBinding BINDING;
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				for (int i = 1; i <= maxIterations && !areWeDone(executionTimes, k, CoV); i++) {
					...
					// BindingUtil.removeBindings(BindingUtil.LOG);
					// BindingUtil.removeBindings(BindingUtil.PROFILE);
					// BindingUtil.removeBindings(BindingUtil.DRAW_CANVAS);
					// BindingUtil.removeBindings(BindingUtil.DRAW_CONSOLE);
	...
	private void activateCanvas() {
		...
		BindingUtil.addBindingInterceptor(aspect.DrawCanvasInsert.class,
				"call(public void shapesPackage.Shapes->insert(..))", BindingUtil.DRAW_CANVAS);
		BindingUtil.addBindingInterceptor(aspect.DrawCanvasDelete.class,
				"call(public void shapesPackage.Shapes->delete(..))", BindingUtil.DRAW_CANVAS);
		BindingUtil.addBindingInterceptor(aspect.DrawCanvasMove.class,
				"call(public void shapesPackage.Shape->moveShape(..))", BindingUtil.DRAW_CANVAS);
		BindingUtil.addBindingInterceptor(aspect.DrawCanvasScale.class,
				"call(public void shapesPackage.Shape->scaleShape(..))", BindingUtil.DRAW_CANVAS);
	}
	...
	private void activateConsole() {
		...
		BindingUtil.addBindingInterceptor(aspect.DrawConsoleInsert.class,
				"call(public void shapesPackage.Shapes->insert(..))", BindingUtil.DRAW_CONSOLE);
		BindingUtil.addBindingInterceptor(aspect.DrawConsoleDelete.class,
				"call(public void shapesPackage.Shapes->delete(..))", BindingUtil.DRAW_CONSOLE);
		BindingUtil.addBindingInterceptor(aspect.DrawConsoleMove.class,
				"call(public void shapesPackage.Shape->moveShape(..))", BindingUtil.DRAW_CONSOLE);
		BindingUtil.addBindingInterceptor(aspect.DrawConsoleScale.class,
				"call(public void shapesPackage.Shape->scaleShape(..))", BindingUtil.DRAW_CONSOLE);
	}
	...
	// profilerPointcuts = new ArrayList<Pointcut>(), drawCanvasPointcuts = new
	// ArrayList<Pointcut>(),
	// drawConsolePointcuts = new ArrayList<Pointcut>();

	private static void initPointcuts() {
		// System.out.println("INIT POINTCUTS");
		// AspectFactory aspectFactory = new
		// GenericAspectFactory("aspect.MockAspect", null);
		// System.out.println("Aspect factory done....");
		// AspectDefinition aspectDef = new AspectDefinition("myAspect",
		// Scope.PER_CLASS, aspectFactory);
		//
		...
		// AdviceFactory adviceFactory=new AdviceFactory(aspectDef,
		// "aspectMethod", AdviceType.BEFORE);
		// AdviceBinding binding=null;
		// try {
		// binding = new AdviceBinding(,null);
		//
		...
		try {
			...
			// DrawConsoleConnector

			// RepaintConnector
			// Weaver.weaveAspectForMethodBefore("PaintCanvas.PaintCanvas",
			// "paintIDMS", "aspect.Repaint",
			// "beforePaintIDMS", void.class, Graphics.class, int.class,
			// Shape.class, Operation.class);
			// Weaver.weaveAspectForMethodAfter("PaintCanvas.PaintCanvas",
			// "paintIDMS", "aspect.Repaint", "afterPaintIDMS",
			// void.class, Graphics.class, int.class, Shape.class,
			// Operation.class);
		} catch (Throwable e) {
	...
	// public static void main(String[] args) {
	// initPointcuts();
	// new ClasePrueba().vacio();
	// maxIterations = args.length == 0 ? 1 : 30;
	// k = args.length == 0 ? 1 : 10;
	// SwingUtilities.invokeLater(new Runnable() {
	// 
	// public void run() {
	//
	...
	// Logical logical = new Logical();
	// List<Double> executionTimes = new ArrayList<Double>();
	// for (int i = 1; i <= maxIterations && !areWeDone(executionTimes, k, CoV);
	// i++) {
	//
	// long ini = System.currentTimeMillis();
	...
	JCheckBox jCheckBox_Logger = null;
	JCheckBox jCheckBox_Profiler = null;
	...
	JRadioButton jRadioButton_Both = null;
	...
	public void activateLog() {
		System.out.println("ACTIVATE LOG VISIT");

		BindingUtil.addBinding("aspect.AspectLogger", "actLogger", "activationMessage", AdviceType.AFTER,
				"call(public void main.MainWindow->actLog(..))", BindingUtil.LOG);

		BindingUtil.addBinding("aspect.AspectLogger", "dsactivateLogger", "deactivationMessage", AdviceType.BEFORE,
				"call(public void main.MainWindow->disactivateLog(..))", BindingUtil.LOG);

		if (BINDING == null)
			BINDING = BindingUtil.addBinding("aspect.AspectLogger", "insertLog", "ShapesOperationLog",
					AdviceType.BEFORE, "call(public void shapesPackage.Shapes->insert(..))", BindingUtil.LOG);
		else
			AspectManager.instance().addBinding(BINDING);

		BindingUtil.addBinding("aspect.AspectLogger", "deleteLog", "ShapesOperationLog", AdviceType.BEFORE,
				"call(public void shapesPackage.Shapes->delete(..))", BindingUtil.LOG);

		BindingUtil.addBinding("aspect.AspectLogger", "moveLog", "ShapesOperationLog", AdviceType.BEFORE,
				"call(public void shapesPackage.Shape->moveShape(..))", BindingUtil.LOG);

		BindingUtil.addBinding("aspect.AspectLogger", "scaleLog", "ShapesOperationLog", AdviceType.BEFORE,
				"call(public void shapesPackage.Shape->scaleShape(..))", BindingUtil.LOG);

	}

	public void activateProfiler() {
		System.out.println("ACTIVATE PROF VISIT");

		BindingUtil.addBindingInterceptor(aspect.AspectProfilerAct.class,
				"call(public void main.MainWindow->actProfiler(..))", BindingUtil.PROFILE);

		BindingUtil.addBindingInterceptor(aspect.AspectProfilerDeact.class,
				"call(public void main.MainWindow->disactivateProfiler(..))", BindingUtil.PROFILE);

		BindingUtil.addBindingInterceptor(aspect.AspectProfilerDemo.class,
				"execution(public void demos.DemoTimer->run(..))", BindingUtil.PROFILE);
		BindingUtil.addBindingInterceptor(aspect.AspectProfilerOperation.class,
				"call(public void shapesPackage.Shapes->insert(..))", BindingUtil.PROFILE);
		BindingUtil.addBindingInterceptor(aspect.AspectProfilerOperation.class,
				"call(public void shapesPackage.Shapes->delete(..))", BindingUtil.PROFILE);
		BindingUtil.addBindingInterceptor(aspect.AspectProfilerOperation.class,
				"call(public void shapesPackage.Shape->moveShape(..))", BindingUtil.PROFILE);
		BindingUtil.addBindingInterceptor(aspect.AspectProfilerOperation.class,
				"call(public void shapesPackage.Shape->scaleShape(..))", BindingUtil.PROFILE);
	}
