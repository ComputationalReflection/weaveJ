...
public class MainWindow extends JFrame {
	...
	public class ActionListenerCheckLog implements ActionListener {
		@Override
	...
	public class ActionListenerDelete implements ActionListener {
		...
		public ActionListenerDelete(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerDeleteShape implements ActionListener {
		MainWindow p = null;

		public ActionListenerDeleteShape(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerInsert implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			clearFormInsert();
	 ...
	 * lienzo.
	 */
	public class ActionListenerInsertShape implements ActionListener {
		MainWindow p = null;

		public ActionListenerInsertShape(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerMove implements ActionListener {
		MainWindow p = null;

		public ActionListenerMove(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerMoveShape implements ActionListener {
		MainWindow p = null;

		public ActionListenerMoveShape(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerProfiler implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
	...
	private void activateCanvas() {
		Pointcut[] canvasPointcuts = null;
		try {
			canvasPointcuts = new Pointcut[] {
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "insert", "aspect.DrawCanvas",
							"beforeOperationOnShapes", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "delete", "aspect.DrawCanvas",
							"beforeOperationOnShapes", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "insert", "aspect.DrawCanvas",
							"afterInsertShape", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "delete", "aspect.DrawCanvas",
							"afterDeleteShape", void.class, Shape.class, String.class),

					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "moveShape", "aspect.DrawCanvas",
							"beforeMoveShape", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "scaleShape", "aspect.DrawCanvas",
							"beforeScaleShape", void.class, Shape.class, String.class, Map.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "moveShape", "aspect.DrawCanvas",
							"afterOperationOnShape", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "scaleShape", "aspect.DrawCanvas",
							"afterOperationOnShape", void.class, Shape.class, String.class, Map.class)
		...
		for (Pointcut pointcut : canvasPointcuts)
			drawCanvasPointcuts.add(pointcut);
	}

	private void deactivateCanvas() {

		System.out.println("DeActivating CANVAS");
		for (Pointcut p : drawCanvasPointcuts)
			try {
				p.unweave();
			} catch (Throwable e) {
				e.printStackTrace();
			}
		drawCanvasPointcuts.clear();
	}

	private void activateConsole() {
		Pointcut[] consolePointcuts = null;
		try {
			consolePointcuts = new Pointcut[] {
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "insert", "aspect.DrawConsole",
							"beforeOperationOnShapes", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "delete", "aspect.DrawConsole",
							"beforeOperationOnShapes", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "insert", "aspect.DrawConsole",
							"afterInsertShape", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "delete", "aspect.DrawConsole",
							"afterDeleteShape", void.class, Shape.class, String.class),

					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "moveShape", "aspect.DrawConsole",
							"beforeMoveShape", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "scaleShape", "aspect.DrawConsole",
							"beforeScaleShape", void.class, Shape.class, String.class, Map.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "moveShape", "aspect.DrawConsole",
							"afterMoveShape", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "scaleShape", "aspect.DrawConsole",
							"afterScaleShape", void.class, Shape.class, String.class, Map.class) };
		} catch (Throwable e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		for (Pointcut pointcut : consolePointcuts)
			drawConsolePointcuts.add(pointcut);
	}

	private void deactivateConsole() {

		System.out.println("DeActivating CONSOLE");
		for (Pointcut p : drawConsolePointcuts)
			try {
				p.unweave();
			} catch (Throwable e) {
				e.printStackTrace();
			}
		drawConsolePointcuts.clear();
	}

	public class ActionListenerRadios implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (buttonGroupDrawIn.isSelected(jRadioButton_Canvas.getModel())) {
				...
				// loadConnector =
				// "D:/USR/antiguo/JMFR/tesis/pruebas_otros_sistemas/AspectosWithJasco/src/aspect/ConnectorDrawCanvas.con";
				...
				op = 2;
				// loadConnector =
				// "D:/USR/antiguo/JMFR/tesis/pruebas_otros_sistemas/AspectosWithJasco/src/aspect/ConnectorDrawConsole.con";
	...
	public class ActionListenerRectangle implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
	...
	public class ActionListenerScale implements ActionListener {
		MainWindow p = null;

		public ActionListenerScale(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerScaleShape implements ActionListener {
		MainWindow p = null;

		public ActionListenerScaleShape(MainWindow pruebaBis) {
			this.p = pruebaBis;
		}
	...
	public class ActionListenerSelectShape implements ActionListener {
		private String action = null;
		private MainWindow p = null;
		private String[] sps = null;

		public ActionListenerSelectShape(MainWindow pruebaBis, String action) {
			this.p = pruebaBis;
			this.action = action;
		}
	...
	public class ActionListenerTriangle implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			jLabel1_width.setEnabled(false);
	...
	public static List<Pointcut> loggerPointcuts = new ArrayList<Pointcut>(),
			profilerPointcuts = new ArrayList<Pointcut>(), drawCanvasPointcuts = new ArrayList<Pointcut>(),
			drawConsolePointcuts = new ArrayList<Pointcut>();
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				for (int i = 1; i <= maxIterations && !areWeDone(executionTimes, k, CoV); i++) {
					...
					thisClass.deactivateCanvas();
					thisClass.deactivateConsole();
					thisClass.disactivateLog();
					thisClass.disactivateProfiler();
	 ...
	 * PropertyConfigurator.configure("../log4j.properties"); // final pruebaBis
	 * p = new pruebaBis(); long ini = System.currentTimeMillis();
	 * 
	 * pruebaBis thisClass = new pruebaBis();
	 * thisClass.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	 * thisClass.setVisible(true);
	 * 
	 * thisClass.jCheckBox_Logger.doClick();
	 ...
	 * thisClass.jButton_Demo.doClick();
	 * 
	 * Logical logical = new Logical(); logical.loadDemo("DemoTimer"); long fin
	 ...
	 * 
	 * bw.write(((Integer) (int) res).toString()); bw.close(); //
	 * System.out.println("FICHERO CERRADO."); } catch (IOException e) { // TODO
	...
	public void activateLog() {
		...
		// String loadConnector = null;
		// loadConnector =
		// "D:/USR/antiguo/JMFR/tesis/pruebas_otros_sistemas/AspectosWithJasco/src/aspect/ConnectorLogger.con";
		// logical.loadConnector(loadConnector);
		Pointcut[] logPointcuts = null;
		try {
			logPointcuts = new Pointcut[] {
					Weaver.weaveAspectForMethodAfter("main.MainWindow", "actLog", "aspect.AspectLogger",
							"activationMessage", void.class),
					Weaver.weaveAspectForMethodBefore("main.MainWindow", "disactivateLog", "aspect.AspectLogger",
							"deactivationMessage", void.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "insert", "aspect.AspectLogger",
							"ShapesOperationLog", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "delete", "aspect.AspectLogger",
							"ShapesOperationLog", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "moveShape", "aspect.AspectLogger",
							"moveShapeLog", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "scaleShape", "aspect.AspectLogger",
							"scaleShapeLog", void.class, Shape.class, String.class, Map.class) };
		} catch (Throwable e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		for (Pointcut pointcut : logPointcuts)
			loggerPointcuts.add(pointcut);
	}

	public void activateProfiler() {
		Pointcut[] profilePointcuts = null;
		try {
			profilePointcuts = new Pointcut[] {
					Weaver.weaveAspectForMethodAfter("main.MainWindow", "actProfiler", "aspect.AspectProfiler",
							"activateProfiler", void.class),
					Weaver.weaveAspectForMethodBefore("main.MainWindow", "disactivateProfiler",
							"aspect.AspectProfiler", "deactivateProfiler", void.class),

					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "insert", "aspect.AspectProfiler",
							"profileShapesOperation", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shapes", "delete", "aspect.AspectProfiler",
							"profileShapesOperation", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "moveShape", "aspect.AspectProfiler",
							"profileMoveShape", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodBefore("shapesPackage.Shape", "scaleShape", "aspect.AspectProfiler",
							"profileScaleShape", void.class, Shape.class, String.class, Map.class),

					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "insert", "aspect.AspectProfiler",
							"profileOperationEnd", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shapes", "delete", "aspect.AspectProfiler",
							"profileOperationEnd", void.class, Shape.class, String.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "moveShape", "aspect.AspectProfiler",
							"profileOperationEnd", void.class, Shape.class, String.class, PointA.class),
					Weaver.weaveAspectForMethodAfter("shapesPackage.Shape", "scaleShape", "aspect.AspectProfiler",
							"profileOperationEnd", void.class, Shape.class, String.class, Map.class),

					Weaver.weaveAspectForMethodBefore("demos.Demo1", "run", "aspect.AspectProfiler", "initDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodBefore("demos.Demo2", "run", "aspect.AspectProfiler", "initDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodBefore("demos.Demo3", "run", "aspect.AspectProfiler", "initDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodBefore("demos.Demo4", "run", "aspect.AspectProfiler", "initDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodBefore("demos.DemoTimer", "run", "aspect.AspectProfiler",
							"initDemoProfile", void.class),

					Weaver.weaveAspectForMethodAfter("demos.Demo1", "run", "aspect.AspectProfiler", "endDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodAfter("demos.Demo2", "run", "aspect.AspectProfiler", "endDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodAfter("demos.Demo3", "run", "aspect.AspectProfiler", "endDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodAfter("demos.Demo4", "run", "aspect.AspectProfiler", "endDemoProfile",
							void.class),
					Weaver.weaveAspectForMethodAfter("demos.DemoTimer", "run", "aspect.AspectProfiler",
							"endDemoProfile", void.class)

			};
		} catch (Throwable e) {
			e.printStackTrace();
		}
		for (Pointcut pointcut : profilePointcuts)
			profilerPointcuts.add(pointcut);
	}
	...
	public void disactivateLog() {
		...
		System.out.println("DeActivating CANVAS");
		for (Pointcut p : loggerPointcuts)
			try {
				p.unweave();
			} catch (Throwable e) {
				e.printStackTrace();
			}
		loggerPointcuts.clear();
	...
	public void disactivateProfiler() {
		...
		System.out.println("DeActivating CANVAS");
		for (Pointcut p : profilerPointcuts)
			try {
				p.unweave();
			} catch (Throwable e) {
				e.printStackTrace();
			}
		profilerPointcuts.clear();
	}
