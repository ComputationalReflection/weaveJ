...
public class Program {
	...
	public static void main(String[] args) throws IOException {
		try {
			AdviceBinding binding = new AdviceBinding("call(public void application.Program->addInt(..))", null);
			binding.addInterceptor(aspects.LoggingAspect.class);
		...
		program.method(args.length == 0, program);
	...
	private void method(boolean memory, Program program) throws IOException {
