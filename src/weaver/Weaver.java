...
import weaver.dynamicGeneration.DynamicExceptionHandlerGenerator;
import weaver.dynamicGeneration.DynamicGeneratorAfter;
import weaver.dynamicGeneration.DynamicGeneratorAround;
import weaver.dynamicGeneration.DynamicGeneratorBefore;
import weaver.dynamicGeneration.DynamicGeneratorConstructorAfter;
import weaver.dynamicGeneration.DynamicGeneratorConstructorBefore;
import weaver.dynamicGeneration.DynamicGeneratorForSingleObjectsGeneric;
import weaver.dynamicGeneration.DynamicGeneratorManager;
import weaver.dynamicGeneration.DynamicNameFieldGenerator;
import weaver.dynamicGeneration.DynamicStateFullGenerator;
import weaver.dynamicGeneration.Wrapper;
import weaver.methods.Getter;
import weaver.methods.Method;
import weaver.methods.Setter;
...
public class Weaver {
	...
	private static Pointcut weaveForFullState(Method aspect, Method componentMethod, MethodHandle componentHandle,
		...
		changeCallSite(componentMethod, DynamicGeneratorManager.getDynamicGenerateMethod(aspect, componentHandle, p,
				new DynamicStateFullGenerator(gen, aspectInstance)));
		return p;
	}
