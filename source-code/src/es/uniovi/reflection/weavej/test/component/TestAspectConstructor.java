...
import es.uniovi.reflection.weavej.test.aspects.RationalAspects;
...
public class TestAspectConstructor {
	...
	private final String ASPECT_CLASS = "es.uniovi.reflection.weavej.test.aspects.RationalAspects";

	private final String COMPONENT_CLASS = "es.uniovi.reflection.weavej.test.component.RationalNumber";
