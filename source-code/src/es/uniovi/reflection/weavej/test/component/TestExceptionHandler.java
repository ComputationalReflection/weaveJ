...
/**
 * Unit test to verify the correct operation of the system when the
 * after-throwing advice-type is chosen.
 * 
...
public class TestExceptionHandler {
	...
	private static final String EXCEPTION_CLASS = "es.uniovi.reflection.weavej.test.component.ZeroAsDenominatorException";
