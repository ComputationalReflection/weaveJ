...
import es.uniovi.reflection.weavej.test.aspects.RationalFieldCounter;
import es.uniovi.reflection.weavej.test.aspects.RationalMultipliedBy;
...
public class TestGetSetField {
	...
	private static final String ASPECT_COUNTER_CLASS = "es.uniovi.reflection.weavej.test.aspects.RationalFieldCounter";
	private static final String ASPECT_SAFE_CLASS = "es.uniovi.reflection.weavej.test.aspects.RationalAspects";
	private static final String COMPONENT_CLASS = "es.uniovi.reflection.weavej.test.component.RationalNumber";
