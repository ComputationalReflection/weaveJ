...
import es.uniovi.reflection.weavej.weaver.StaticMethodDecorator;
 ...
 * {@link es.uniovi.reflection.weavej.weaver.Decorator Decorator } is employed.
 * Its functionality is partially implemented delegating to the
...
public class DynamicGeneratorAround extends DefaultComponentGenerator {
	...
	public void visitMethodHandleSetter(ClassWriter cw) {
		...
		final String decoratorClass = "es/uniovi/reflection/weavej/weaver/Decorator",
				decoratorClassDesc = "L" + decoratorClass + ";";
		{
			...
			methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, decoratorClass, "decorate",
