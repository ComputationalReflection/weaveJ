...
import es.uniovi.reflection.weavej.util.GenericSet;
import es.uniovi.reflection.weavej.weaver.PointcutForObjects;
 ...
 * weaving is required. The class
 * {@link es.uniovi.reflection.weavej.util.GenericSet GenericSet } is used only
 * here to store the objects which are affected by the weaving. The
 * functionality of this class is partially implemented delegating to other
 * {@link es.uniovi.reflection.weavej.weaver.dynamicGeneration.Wrapper Wrapper
 * }. This {@link es.uniovi.reflection.weavej.weaver.dynamicGeneration.Wrapper
 * Wrapper } can be any of the ones used to generate other woven methods except
 * the constructors generators or the
 * {@link es.uniovi.reflection.weavej.weaver.dynamicGeneration.DynamicStatefulGenerator
...
public class DynamicGeneratorForSingleObjectsGeneric extends DefaultComponentGenerator implements Wrapper {
	...
	private static final String setClass = "es/uniovi/reflection/weavej/util/GenericSet",
			setClassDesc = "L" + setClass + ";";
	...
	public void invokeMethodsBefore(MethodVisitor methodVisitor, Method aspectMethod)
		...
		methodVisitor.visitMethodInsn(Opcodes.INVOKEVIRTUAL, setClass, "contains",
